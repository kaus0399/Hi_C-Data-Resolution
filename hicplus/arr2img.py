...
InFile = gzip.GzipFile('../data/GM12878_replicate_down16_chr19_22.npy.gz', "r") ## input .npy file
#InFile = gzip.GzipFile('../data/GM12878_replicate_original_chr19_22.npy.gz', "r")
HiC_max_value = 100
